...
A of machine learning frameworks, libraries and software (by language). 

_If you want to contribute to this list (please do), send me a pull request or contact me [phil@clairbot.com)
